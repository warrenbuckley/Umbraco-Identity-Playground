...
using Umbraco_Identity_Playground;
...
namespace Umbraco_Identity_Playground
{
    /// <summary>
    ...
    public class UmbracoStandardOwinStartup : UmbracoDefaultOwinStartup
    {
        public override void Configuration(IAppBuilder app)
        {
            ...
            var clientId = "903993111999-i8em676kego06771hn7fqmr727b58gnk.apps.googleusercontent.com";
            var clientSecret = "L46oZKTgwJCNNmsrmuVDLrSr";

            app.ConfigureBackOfficeGoogleAuth(clientId, clientSecret);
